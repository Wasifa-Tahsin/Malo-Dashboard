...
const Dashboard = () => {
  return (
    // Horizontal scroll wrapper for the whole dashboard
    <div className="overflow-x-auto w-full">
      {/* Inner container with min-width to enable scroll */}
      <div className="flex flex-col gap-6 p-4 sm:p-6 lg:p-8 bg-[#FCF7E6] min-h-screen min-w-[800px]">
        
        {/* ===== Stats Cards (stacked full width) ===== */}
